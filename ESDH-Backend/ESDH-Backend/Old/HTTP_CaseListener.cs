...
//    public class HTTP_CaseListener {
//        private readonly ILogger<HTTP_CaseListener> _logger;
//        private readonly IConfiguration _config;

//        public HTTP_CaseListener(ILogger<HTTP_CaseListener> logger, IConfiguration config) {
//            _logger = logger;
//            _config = config;
//        }

//        [Function(nameof(HTTP_CaseListener))]
...
//            QueueClient queueClient = new(_config["AzureWebJobsStorage"], "esdhcase-queue");
