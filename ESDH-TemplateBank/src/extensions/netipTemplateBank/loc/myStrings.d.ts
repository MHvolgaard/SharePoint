declare interface INetipTemplateBankCommandSetStrings {
  advanced: string;
  Command1: string;
  Command2: string;
  create: string;
...
declare module 'NetipTemplateBankCommandSetStrings' {
  const strings: INetipTemplateBankCommandSetStrings;
  export = strings;
}
